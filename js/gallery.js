...
basicLightboxStyles.href ='https://cdn.jsdelivr.net/npm/basiclightbox@5/dist/basicLightbox.min.css';
document.head.appendChild(basicLightboxStyles);

const basicLightboxScript = document.createElement('script');
basicLightboxScript.src ='https://cdn.jsdelivr.net/npm/basiclightbox@5/dist/basicLightbox.min.js';
document.body.appendChild(basicLightboxScript);

basicLightboxScript.onload = () => {
  initializeGallery();
};
